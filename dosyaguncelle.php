...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE dersicerik SET dosyabasligi=%s, dosyaaciklamasi=%s, dosyalinki=%s WHERE dosyaID=%s",
  ...
  $updateGoTo = "dersgoster.php?ders={$ders}&olay=dosyaguncelle";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="cevreleyen">
  ...
  <form action="<?php echo $editFormAction; ?>" id="form2" name="form2" method="POST">
    <h1>Dosya Güncelle </h1>
    <table class="innerIcerik" width="99%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="19%" height="38"><span class="unvan2">Dosya Baþlýðý </span></td>
      <td width="60%"><input name="dosyabasligi" type="text" class="giris" id="formalani" value="<?php echo $row_dosyabilgileri['dosyabasligi']; ?>" size="50" /></td>
      <td width="21%">&nbsp;</td>
    </tr>
    <tr>
      <td height="27"><span class="unvan2">Dosya Açýklamasý </span></td>
      <td><textarea name="dosyaaciklamasi" class="giris" cols="50" rows="6" id="formalani"><?php echo $row_dosyabilgileri['dosyaaciklamasi']; ?></textarea></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="36"><span class="unvan2">Dosya Linki </span></td>
      <td><input name="dosyalinki" type="text" class="giris" id="formalani" value="<?php echo $row_dosyabilgileri['dosyalinki']; ?>" size="50" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="65">&nbsp;</td>
      <td><span class="style4"><a href="dosyayenile.php?asama=1&amp;dosyaID=<?php echo $row_dosyabilgileri['dosyaID']; ?>&amp;ders=<?=$ders?>">Bu dosyayý baþka bir dosya ile deðiþtirmek için týklayýn.</a></span></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="27">&nbsp;</td>
      <td><input name="dosyaID" type="hidden" id="dosyaID" value="<?php echo $row_dosyabilgileri['dosyaID']; ?>" />
        <input type="submit" id="formGonder" name="Submit" value="Dosyayý Kaydet" /></td>
      <td>&nbsp;</td>
    </tr>
  </table>
