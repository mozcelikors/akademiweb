...
<div id="cevreleyen">
  ...
  <div id="icerik">
  <span class="style1">Dosya yüklenirken beklemeniz gerekmektedir. | Dosyayý görüntüleyemiyorsanýz Google Chrome kullanmayý deneyiniz. | <a href="<?php echo $row_dosyadetay['dosyalinki']; ?>">Dosyayý Kaydet</a>  </span>
