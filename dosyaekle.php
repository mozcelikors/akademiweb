...
<div id="cevreleyen">
  ...
  <form id="form1" name="form1" method="post" enctype="multipart/form-data" action="dosyaekle_asama2.php?ders=<?=$ders?>">
	...
	<tr>
		<td width="425"><input style="padding:20px 20px 20px 20px; font-family:'Calibri', Arial, Times, serif; border:#999999 1px solid;" type="file" id="formalani" name="dosya" size="40">
		  <input name="submit" type="submit" id="formGonder" value="Yükle" /></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
  ...
  </form><?php }else{echo "<br /><h1><font color=\"red\">BU ALANA BU ÞEKÝLDE ULAÞAMAZSINIZ !</font></h1>";
  exit;} ?>
...
if($yukle){
	echo "<br><center>Dosya baþarýyla yuklendi<br></center><br>";
...
<form id="form2" name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="99%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="30" class="unvan2">Dosya Baþlýðý </td>
