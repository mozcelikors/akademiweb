$(document).ready(function(){
	...
	function uzerinde(){
		$(this).animate({
			...
			height:'+=5px',
			fontWeight:'bold',
			backgroundImage:'url(temalar/yesil_tema/menubutonh.png)'
		},200);
		
		
	}
	function disinda(){
		 $(this).css('backgroundImage','url(temalar/yesil_tema/menubuton.png)');
		 $(this).animate({
			 opacity:1,
			fontSize:'14px',
			height:'-=5px',
	...
	function uzerinde2(){
		...
		$(this).animate({
			...
			height:'+=5px',
			fontWeight:'bold',
			backgroundImage:'url(temalar/yesil_tema/menubutonapos.png)'
		},200);
	...
	function disinda2(){
		 $(this).animate({
			...
			height:'-=5px',
			fontWeight:'normal',
			backgroundImage:'url(temalar/yesil_tema/menubutona.png)'
