...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE dersicerik SET dosyabasligi=%s, dosyaaciklamasi=%s, dosyalinki=%s, did=%s WHERE dosyaID=%s",
...
if($yukle){
	...
	echo "<h1>Dosya Yuklenemedi<br></h1><br>";
...
<form action="<?php echo $editFormAction; ?>" id="form2" name="form2" method="POST">
  <table class="innerIcerik" width="99%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="38"><span class="unvan2">Dosya Baþlýðý </span></td>
      <td><input class="giris" name="dosyabasligi" type="text" id="dosyabasligi" value="<?php echo $row_dosyabilgileri['dosyabasligi']; ?>" /></td>
      </tr>
    <tr>
      <td height="27" valign="top"><span class="unvan2">Dosya Açýklamasý </span></td>
      <td><textarea name="dosyaaciklamasi" cols="50" rows="6" class="giris" id="dosyaaciklamasi"><?php echo $row_dosyabilgileri['dosyaaciklamasi']; ?></textarea></td>
      </tr>
    <tr>
      <td height="54">&nbsp;</td>
      <td><input name="dosyaID" type="hidden" id="dosyaID" value="<?php echo $row_dosyabilgileri['dosyaID']; ?>" />
      <input name="dosyalinki" type="hidden" id="dosyalinki" value="<?php echo $hedef.'/'.$yeniresimadi; ?>" />
        <input name="did" type="hidden" id="did" value="<?php echo $row_dosyabilgileri['did']; ?>" />
