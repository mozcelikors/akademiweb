...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO duyurular (duyuruaciklamasi, duyurulink, did, duyurudosyalink, tarih) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['duyuruaciklamasi'], "text"),
                       GetSQLValueString("YOK", "text"),
...
<script type="text/javascript" language="javascript">
	function kontrol(){
		if(document.form1.duyuruaciklamasi.value==""){
			alert("Lütfen hiç bir alaný boþ býrakmayýn.. ");
			return false;
			
		}
		if(document.form1.duyurulink.value==""){
			alert("Lütfen hiç bir alaný boþ býrakmayýn.. ");
			return false;
  ...
  <form onsubmit="return kontrol()" id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    ...
    <table class="innerIcerik" width="700" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="56%"><textarea name="duyuruaciklamasi" cols="50" rows="6" class="giris" id="formalani"></textarea></td>
        </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td><input name="duyurudosyalink" type="hidden" id="duyurudosyalink" value="yok" />
          <input name="tarih" type="hidden" id="tarih" value="<?php echo date(d.".".m.".".Y)." ".date(H.":".i); ?>" />
